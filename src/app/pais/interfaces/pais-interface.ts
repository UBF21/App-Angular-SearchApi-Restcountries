...
//
//   const resCountriesResponse = Convert.toResCountriesResponse(json);
//
...
export class Convert {
    public static toResCountriesResponse(json: string): Pais[] {
        return cast(JSON.parse(json), a(r("ResCountriesResponse")));
    }

    public static resCountriesResponseToJson(value: Pais[]): string {
        return JSON.stringify(uncast(value, a(r("ResCountriesResponse"))), null, 2);
    }
}
